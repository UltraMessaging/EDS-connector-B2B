package com.informatica.messaging.vds.sources.camel.netty4;
 ...
 *
 */
public class CamelNetty4Source implements VDSSource, VDSCamelConstants {

    /*** 
     * Netty4 plugin properties 
     * 
     ***/
    private static final String TCP = "TCP";
    private static final String NETTY4_PROTOCOL = "netty4Protocol";
    ...
    private static final Logger _logger = LoggerFactory.getLogger(CamelNetty4Source.class);
	...
	public void close() throws IOException {
        ...
        _logger.info("Closing Camel Netty4 Source...");
        ...
        try {
            ...
            _logger.error("Exception while closing Camel Netty4 Source: {}", e.getMessage(), e);
        }
	}
	...
	public void open(VDSConfiguration vdsConfiguration) throws Exception {
        ...
        _logger.info("Opening Camel Netty4 Source for reading...");
        ...
        Thread camelTask = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    _logger.error("Exception while opening Camel Netty4 Source: {}", e.getMessage(), e);
                }
	...
	public void read(VDSEventList vdsEventList) throws Exception {
        ...
        _logger.debug("Reading from Camel Netty4 Source...");
	...
	public void parseConfig(VDSConfiguration vdsConfiguration) throws Exception {
        ...
        String netty4Protocol = vdsConfiguration.getString(NETTY4_PROTOCOL);
        ...
        String tcpOptins = "";
        if (netty4Protocol.equalsIgnoreCase(TCP)) {
         ...
         */
        String camelFromURI = "netty4:" + netty4Protocol.toLowerCase() + "://" + ipAddress + ":" + port + "?sync=true"
                + tcpOptins;
