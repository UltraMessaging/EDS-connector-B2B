package com.informatica.messaging.vds.sources.camel.mina2;
...
/**
 * Camel Component for Apache MINA2
 * @author hpurohit
 *
 */
public class CamelMina2Source implements VDSSource, VDSCamelConstants {

    /*** 
     * Mina2 plugin properties 
     * 
     ***/
    private static final String TCP = "TCP";
    private static final String MINA2_PROTOCOL = "mina2Protocol";
    ...
    private static final Logger _logger = LoggerFactory.getLogger(CamelMina2Source.class);
	...
	public void close() throws IOException {
        ...
        _logger.info("Closing Camel Mina2 Source...");
        ...
        try {
            ...
            _logger.error("Exception while closing Camel Mina2 Source: {}", e.getMessage(), e);
        }
	}
	...
	public void open(VDSConfiguration vdsConfiguration) throws Exception {
        ...
        _logger.info("Opening Camel Mina2 Source for reading...");
        ...
        Thread camelTask = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    _logger.error("Exception while opening Camel Mina2 Source: {}", e.getMessage(), e);
                }
	...
	public void read(VDSEventList vdsEventList) throws Exception {
        ...
        _logger.debug("Reading from Camel Mina2 Source...");
	...
	/**
     * Parses the configurations defined in vdsplugin.xml 
	...
	public void parseConfig(VDSConfiguration vdsConfiguration) throws Exception {
         ...
         */
        String ipAddress = vdsConfiguration.getString(IP_ADDRESS);
        String port = vdsConfiguration.getString(PORT);
        String mina2Protocol = vdsConfiguration.getString(MINA2_PROTOCOL);
        ...
        String tcpOptins = "";
        if (mina2Protocol.equalsIgnoreCase(TCP)) {
            tcpOptins = "&textline=true";
        }

        /**
         * Construct camel component from URI
         */
        String camelFromURI = "mina2:" + mina2Protocol.toLowerCase() + "://" + ipAddress + ":" + port + "?sync=true"
                + tcpOptins;
