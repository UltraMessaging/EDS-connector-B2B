package com.informatica.messaging.vds.sources.camel.couchdb;
...
/**
 * Camel Component for Couch DB
 * @author hpurohit
 *
 */
public class CamelCouchDbSource implements VDSSource, VDSCamelConstants {

    /*** 
     * Couch DB plugin properties 
     * 
     ***/
    private static final String COUCH_DB_PASSWORD = "couchDbPassword";
    private static final String COUCH_DB_USER_NAME = "couchDbUserName";
    private static final String COUCH_DB_NAME = "couchDbName";
    private static final String COUCH_DB_PORT = "couchDbPort";
    private static final String COUCH_DB_SERVER_IP = "couchDbServerIp";
    ...
    private static final Logger _logger = LoggerFactory.getLogger(CamelCouchDbSource.class);
	...
	public void close() throws IOException {
        ...
        _logger.info("Closing Camel Couch DB Source...");
        ...
        try {
            ...
            _logger.error("Exception while closing Camel Couch DB Source: {}", e.getMessage(), e);
        }
	}
	...
	public void open(VDSConfiguration vdsConfiguration) throws Exception {
        ...
        _logger.info("Opening Camel Couch DB Source for reading...");
        ...
        Thread camelTask = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    _logger.error("Exception while opening Camel Couch DB Source: {}", e.getMessage(), e);
                }
	...
	public void read(VDSEventList vdsEventList) throws Exception {
        ...
        _logger.debug("Reading from Camel Couch DB Source...");
	...
	public void parseConfig(VDSConfiguration vdsConfiguration) throws Exception {
         ...
         */
        String couchDbServerIp = vdsConfiguration.getString(COUCH_DB_SERVER_IP);
        String couchDbPort = vdsConfiguration.getString(COUCH_DB_PORT);
        String couchDbName = vdsConfiguration.getString(COUCH_DB_NAME);
        String couchDbUserName = vdsConfiguration.getString(COUCH_DB_USER_NAME);
        String couchDbPassword = vdsConfiguration.getString(COUCH_DB_PASSWORD);
        ...
        String couchDbAuthOptions = "";
        if (couchDbUserName != null && !couchDbUserName.trim().equals("") && couchDbPassword != null
                && !couchDbPassword.trim().equals("")) {
            couchDbAuthOptions = "?username=" + couchDbUserName + "&password=" + couchDbPassword;
        }

        /**
         * Construct camel component from URI
         */
        String camelFromURI = "couchdb:http://" + couchDbServerIp + ":" + couchDbPort + "/" + couchDbName
                + couchDbAuthOptions;
