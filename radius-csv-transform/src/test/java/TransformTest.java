...
import com.informatica.vds.custom.transforms.radius_csv_transform.RadiusCsvTransform;
...
public class TransformTest {
	...
	public static void main(String args[]) {
		...
		RadiusCsvTransform testTransform;
		...
		try {
			...
			writer.flush();
			testTransform = new RadiusCsvTransform(true, writer);
	...
	private static void process_cmdline(String _progname, String[] args) {
		try {
			...
			Getopt g = new Getopt(_progname, args, "u:r:n:", longopts);
